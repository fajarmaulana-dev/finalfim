...
declare const _default: {
    new (...args: any[]): {
        ...
        $props: Partial<{
            ...
            shape: string;
            maxInitial: number;
        }>>> & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "size" | "shape" | "maxInitial">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
    ...
    $slots: typeof import('./Avatar.vue.__VLS_template').default;
});
