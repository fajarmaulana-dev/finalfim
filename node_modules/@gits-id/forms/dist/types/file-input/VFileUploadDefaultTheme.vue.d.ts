declare const _default: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "changeText" | "removeText" | "borderClass">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
    ...
    $slots: typeof import('./VFileUploadDefaultTheme.vue.__VLS_template').default;
});
